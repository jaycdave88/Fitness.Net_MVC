...
!function () {
    ...
    jQuery.extend(!0, t, {
        resetVideo: function (t) {
            switch (t.data("videotype")) {
                ...
                case "vimeo":
                    ...
                    break;
                case "html5":
                    if (a && 1 == t.data("disablevideoonmobile"))
                        return !1;
                    var n = t.find("video")
                      , r = n[0];
        ...
        playVideo: function (o, n) {
            switch (clearTimeout(o.data("videoplaywait")),
            o.data("videotype")) {
                case "youtube":
                    if (0 == o.find("iframe").length)
                        o.append(o.data("videomarkup")),
                        d(o, n, !0);
                        ...
                        o.data("videoplaywait", setTimeout(function () {
                            t.playVideo(o, n)
                        }, 50));
                    break;
                case "vimeo":
                    if (0 == o.find("iframe").length)
                        ...
                        var s = o.find("iframe").attr("id")
                          , p = $f(s);
                        void 0 == p.api("play") ? o.data("videoplaywait", setTimeout(function () {
                            t.playVideo(o, n)
                    ...
                    break;
                case "html5":
                    if (a && 1 == o.data("disablevideoonmobile"))
                        return !1;
                    var l = o.find("video")
                      , v = l[0]
                      , u = l.parent();
                    if (1 != u.data("metaloaded"))
                        i(v, "loadedmetadata", function (a) {
                            t.resetVideo(a, n),
                            v.play();
        ...
        checkVideoApis: function (e, t, a) {
            ...
            if ((void 0 != e.data("ytid") || e.find("iframe").length > 0 && e.find("iframe").attr("src").toLowerCase().indexOf("youtube") > 0) && (t.youtubeapineeded = !0),
            (void 0 != e.data("ytid") || e.find("iframe").length > 0 && e.find("iframe").attr("src").toLowerCase().indexOf("youtube") > 0) && 0 == a.addedyt) {
                t.youtubestarttime = jQuery.now(),
                a.addedyt = 1;
            ...
            if ((void 0 != e.data("vimeoid") || e.find("iframe").length > 0 && e.find("iframe").attr("src").toLowerCase().indexOf("vimeo") > 0) && (t.vimeoapineeded = !0),
            (void 0 != e.data("vimeoid") || e.find("iframe").length > 0 && e.find("iframe").attr("src").toLowerCase().indexOf("vimeo") > 0) && 0 == a.addedvim) {
                t.vimeostarttime = jQuery.now(),
                a.addedvim = 1;
        ...
        manageVideoLayer: function (o, r) {
            ...
            switch (o.data("videotype", w),
            b) {
                case "html5":
                    "controls" != h && (h = "");
                    var k = '<video style="object-fit:cover;background-size:cover;visible:hidden;width:100%; height:100%" class="" ' + y + ' preload="' + v + '">';
                    void 0 != c && "firefox" == t.get_browser().toLowerCase() && (k = k + '<source src="' + c + '" type="video/webm" />'),
                    void 0 != u && (k = k + '<source src="' + u + '" type="video/mp4" />'),
                    void 0 != f && (k = k + '<source src="' + f + '" type="video/ogg" />'),
                    k += "</video>";
                    var T = "";
                    ("true" === m || m === !0) && (T = '<div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-full-screen">Full-Screen</button></div>'),
                    "controls" == h && (k += '<div class="tp-video-controls"><div class="tp-video-button-wrap"><button type="button" class="tp-video-button tp-vid-play-pause">Play</button></div><div class="tp-video-seek-bar-wrap"><input  type="range" class="tp-seek-bar" value="0"></div><div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-mute">Mute</button></div><div class="tp-video-vol-bar-wrap"><input  type="range" class="tp-volume-bar" min="0" max="1" step="0.1" value="1"></div>' + T + "</div>"),
                ...
                case "youtube":
                    ...
                    "none" == h && (s = s.replace("controls=1", "controls=0"),
                    -1 == s.toLowerCase().indexOf("controls") && (s += "&controls=0"));
                    ...
                    var C = s.split("origin=" + g + "://")
                      , V = "";
                    C.length > 1 ? (V = C[0] + "origin=" + g + "://",
                    self.location.href.match(/www/gi) && !C[1].match(/www/gi) && (V += "www."),
                    V += C[1]) : V = s;
                ...
                case "vimeo":
                    "https:" === location.protocol && (g = "https"),
                    o.data("videomarkup", '<iframe style="visible:hidden" src="' + g + "://player.vimeo.com/video/" + l + "?" + s + '" width="100%" height="100%" style="100%;height:100%"></iframe>')
            }
            ...
            0 == o.find("iframe").length && o.find(".tp-videoposter").click(function () {
                if (t.playVideo(o, r),
                a) {
                    if (1 == o.data("disablevideoonmobile"))
                        return !1;
            ...
            })) : 0 != o.find("iframe").length || "youtube" != w && "vimeo" != w || (o.append(o.data("videomarkup")),
            d(o, r, !1)),
            ...
            1 == o.data("bgvideo") && punchgs.TweenLite.set(o.find("video, iframe"), {
                autoAlpha: 0
            })
        }
    });
    var i = function (e, t, a) {
      ...
      , d = function (i, d, n) {
          ...
          if (v = "loop" == v || "loopandnoslidestop" == v,
          1 == i.data("forcecover")) {
          ...
          1 !== i.data("videolistenerexist"))
              switch (i.data("videotype")) {
                  case "youtube":
                          ...
                          events: {
                              onStateChange: function (t) {
                                  ...
                                  if (t.data == YT.PlayerState.PLAYING)
                                      punchgs.TweenLite.to(p.find(".tp-videoposter"), .3, {
                                          autoAlpha: 0,
                                          force3D: "auto",
                                          ease: punchgs.Power3.easeInOut
                                      }),
                                      punchgs.TweenLite.to(p.find("iframe"), .3, {
                                          autoAlpha: 1,
                                          display: "block",
                                          ease: punchgs.Power3.easeInOut
                                      }),
                                      "mute" == p.data("volume") ? l.mute() : (l.unMute(),
                                      ...
                                      (0 == t.data || 2 == t.data) && "on" == p.data("showcoveronpause") && p.find(".tp-videoposter").length > 0 && (punchgs.TweenLite.to(p.find(".tp-videoposter"), .3, {
                                          autoAlpha: 1,
                                          force3D: "auto",
                                          ease: punchgs.Power3.easeInOut
                                      }),
                                      ...
                                      -1 != t.data && 3 != t.data && (d.videoplaying = !1,
                                      s(p, d),
                                      n.trigger("starttimer"),
                                      d.c.trigger("revolution.slide.onvideostop", o(l, "youtube", p.data()))),
                                      0 == t.data && 1 == p.data("nextslideatend") ? (d.c.revnext(),
                                      s(p, d)) : (s(p, d),
                                      d.videoplaying = !1,
                                      n.trigger("starttimer"),
                                      d.c.trigger("revolution.slide.onvideostop", o(l, "youtube", p.data())))
                      ...
                      break;
                  case "vimeo":
                      for (var m, h = p.attr("src"), g = {}, y = h, w = /([^&=]+)=([^&]*)/g; m = w.exec(y) ;)
                      ...
                      k.addEvent("ready", function () {
                          ...
                          k.addEvent("play", function () {
                              ...
                              "mute" == i.data("volume") ? k.api("setVolume", "0") : k.api("setVolume", parseInt(i.data("volume"), 0) / 100 || .75)
                          }),
                          k.addEvent("playProgress", function (t) {
                              ...
                              if (0 != a && Math.abs(a - t.seconds) < .3 && a > t.seconds && 1 != i.data("nextslidecalled"))
                                  if (v) {
                                      ...
                                      1 == i.data("nextslideatend") && (i.data("nextslidecalled", 1),
                                      d.c.revnext()),
                                      k.api("pause")
                          }),
      ...
      , n = function (d, n) {
          if (a && 1 == d.data("disablevideoonmobile"))
              return !1;
          var p = d.find("video")
            , l = p[0]
            , v = p.parent()
          ...
          if (u = "loop" == u || "loopandnoslidestop" == u,
          v.data("metaloaded", 1),
          void 0 == p.attr("control") && (0 != d.find(".tp-video-play-button").length || a || d.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><span class="tp-revstop">&nbsp;</span></div>'),
          ...
          i(h, "click", function () {
              0 == l.muted ? (l.muted = !0,
              h.innerHTML = "Unmute") : (l.muted = !1,
              h.innerHTML = "Mute")
          }),
          g && i(g, "click", function () {
          ...
          i(l, "timeupdate", function () {
              var t = 100 / l.duration * l.currentTime
                ...
                , i = l.currentTime;
              if (y.value = t,
              0 != a && Math.abs(a - i) <= .3 && a > i && 1 != d.data("nextslidecalled"))
                  if (u) {
                      l.play();
                      var o = e(d.data("videostartat"));
                      -1 != o && (l.currentTime = o)
                  } else
                      1 == d.data("nextslideatend") && (d.data("nextslidecalled", 1),
                      n.c.revnext()),
                      l.pause()
          }),
          i(y, "mousedown", function () {
              d.addClass("seekbardragged"),
              l.pause()
          }),
          i(y, "mouseup", function () {
              d.removeClass("seekbardragged"),
              l.play()
          }),
          i(w, "change", function () {
              l.volume = w.value
          ...
          i(l, "play", function () {
              ...
              n.c.trigger("revolution.slide.onvideoplay", o(l, "html5", d.data()))) : (n.videoplaying = !1,
              n.c.trigger("starttimer"),
              n.c.trigger("revolution.slide.onvideostop", o(l, "html5", d.data()))),
              punchgs.TweenLite.to(d.find(".tp-videoposter"), .3, {
                  autoAlpha: 0,
                  force3D: "auto",
                  ease: punchgs.Power3.easeInOut
              }),
      ...
      , r = function (e, a) {
          ...
          e.data("stopallvideos") && void 0 != a.playingvideos && a.playingvideos.length > 0 && (a.lastplayedvideos = jQuery.extend(!0, [], a.playingvideos),
