...
!function () {
    ...
    var e = function (e, o, a, i) {
        ...
        void 0 != r.data("curscale") && "box" == i ? s = 100 * r.data("curscale") : void 0 != r.data("curscale") && (s = r.data("curscale")),
        t.slotSize(r, o);
        var d = r.attr("src")
          ...
          , p = r.data("fxof")
          , u = 0;
        "on" == o.autoHeight && (c = o.c.height()),
        void 0 == p && (p = 0);
        var g = 0
          , w = r.data("bgfit")
          , v = r.data("bgrepeat")
          , m = r.data("bgposition");
        switch (void 0 == w && (w = "cover"),
        ...
        i) {
            case "box":
                var x = 0
                  , y = 0
                  , T = 0;
                if (x = o.sloth > o.slotw ? o.sloth : o.slotw,
                !a)
                    var g = 0 - x;
                o.slotw = x,
                o.sloth = x;
            ...
            case "horizontal":
                if ("horizontal" == i) {
                    if (!a)
                        var g = 0 - o.slotw;
                    for (var L = 0; L < o.slots; L++)
                        n.append('<div class="slot" style="position:absolute;top:' + (0 + u) + "px;left:" + (p + L * o.slotw) + "px;overflow:hidden;width:" + (o.slotw + .6) + "px;height:" + c + 'px"><div class="slotslide" style="position:absolute;top:0px;left:' + g + "px;width:" + (o.slotw + .6) + "px;height:" + c + 'px;overflow:hidden;"><div style="background-color:' + h + ";position:absolute;top:0px;left:" + (0 - L * o.slotw) + "px;width:" + f + "px;height:" + c + "px;background-image:url(" + d + ");background-repeat:" + v + ";background-size:" + w + ";background-position:" + m + ';"></div></div></div>'),
                        void 0 != s && void 0 != l && punchgs.TweenLite.set(n.find(".slot").last(), {
                            rotationZ: l
                        })
                } else {
                    ...
                    for (var L = 0; L < o.slots + 2; L++)
                        n.append('<div class="slot" style="position:absolute;top:' + (u + L * o.sloth) + "px;left:" + p + "px;overflow:hidden;width:" + f + "px;height:" + o.sloth + 'px"><div class="slotslide" style="position:absolute;top:' + g + "px;left:0px;width:" + f + "px;height:" + o.sloth + 'px;overflow:hidden;"><div style="background-color:' + h + ";position:absolute;top:" + (0 - L * o.sloth) + "px;left:0px;width:" + f + "px;height:" + c + "px;background-image:url(" + d + ");background-repeat:" + v + ";background-size:" + w + ";background-position:" + m + ';"></div></div></div>'),
                        void 0 != s && void 0 != l && punchgs.TweenLite.set(n.find(".slot").last(), {
                            rotationZ: l
                        })
                }
      ...
      , o = function (t, e, o, a, i) {
          ...
          o = u[o]),
          "random-premium" == o && (o = Math.round(Math.random() * g.length - 1),
      ...
      , i = function (t, i, n, r, s, l, d, h, f) {
          function c(t, e, o, a, i) {
              ...
              t.find(".slot-circle-wrapper").each(function (t) {
                  if (r > t) {
                      ...
                      f.add(punchgs.TweenLite.fromTo(a, .001, {
                          autoAlpha: 0
                      }, {
                          autoAlpha: 1
                      }), 0)
          ...
          11 != t && (null != v[7] && e(h, r, v[7], v[5]),
          null != v[6] && e(d, r, v[6], v[5])),
          f.add(punchgs.TweenLite.set(d.find(".defaultvid"), {
              y: 0,
              x: 0,
              top: 0,
              left: 0,
          ...
          f.add(punchgs.TweenLite.set(h.find(".defaultvid"), {
              y: 0,
              x: 0,
              top: 0,
              left: 0,
          ...
          f.add(punchgs.TweenLite.set(d, {
              autoAlpha: 1,
              y: "+0%",
              x: "+0%"
          }), 0),
          f.add(punchgs.TweenLite.set(h, {
              autoAlpha: 1,
              y: "+0%",
              x: "+0%"
          }), 0),
          f.add(punchgs.TweenLite.set(d.parent(), {
          ...
          if (T = "default" === T ? v[9] || punchgs.Power2.easeInOut : T || v[9] || punchgs.Power2.easeInOut,
          z = "default" === z ? v[10] || punchgs.Power2.easeInOut : z || v[10] || punchgs.Power2.easeInOut,
          0 == t) {
              ...
              d.find(".slotslide").each(function (t) {
                  ...
                  b += 1,
                  b == L && (b = 0),
                  f.add(punchgs.TweenLite.from(e, y / 600, {
                      opacity: 0,
                      top: 0 - r.sloth,
                      left: 0 - r.slotw,
                      rotation: r.rotate,
          ...
          if (1 == t) {
              ...
              d.find(".slotslide").each(function (t) {
                  ...
                  o + a > D && (D = a + a,
                  A = t),
                  f.add(punchgs.TweenLite.from(e, o / 1e3, {
                      autoAlpha: 0,
                      force3D: "auto",
                      rotation: r.rotate,
                      ease: T
          ...
          if (4 == t || 5 == t) {
              ...
              h.find(".slotslide").each(function (e) {
                  ...
                  j.add(punchgs.TweenLite.to(o, 3 * k, {
                      transformPerspective: 600,
                      force3D: "auto",
                      top: 0 + r.height,
                      opacity: .5,
              ...
              d.find(".slotslide").each(function (e) {
                  var o = jQuery(this)
                    , a = e * k / r.slots;
                  5 == t && (a = (r.slots - e - 1) * k / r.slots / 1.5),
                  j.add(punchgs.TweenLite.from(o, 3 * k, {
                      top: 0 - r.height,
                      opacity: .5,
                      rotation: r.rotate,
                      force3D: "auto",
          ...
          if (31 == t || 32 == t || 33 == t || 34 == t) {
              ...
              f.add(punchgs.TweenLite.fromTo(h, B - .2 * B, {
                  y: 0,
                  x: 0
              }, {
                  y: ty,
              ...
              f.add(punchgs.TweenLite.fromTo(d, B, {
                  y: fy,
                  x: fx
              }, {
                  y: "0%",
          ...
          if (11 == t) {
              ...
              switch (m) {
                  ...
                  case 1:
                      ...
                      f.add(punchgs.TweenLite.fromTo(h, y / 1e3, {
                          autoAlpha: 1
                      }, {
                          autoAlpha: 0,
                          force3D: "auto",
                  ...
                  case 4:
                      ...
                      f.add(punchgs.TweenLite.to(h, y / 2e3, {
                          autoAlpha: 0,
                          force3D: "auto",
                          ease: T
                      }), 0),
                      f.add(punchgs.TweenLite.fromTo(d, y / 2e3, {
                          autoAlpha: 0
                      }, {
                          autoAlpha: 1,
                          force3D: "auto",
              ...
              f.add(punchgs.TweenLite.set(h.find("defaultimg"), {
                  autoAlpha: 1
              }), 0)
          }
          if (26 == t) {
              ...
              f.add(punchgs.TweenLite.to(h, y / 1e3, {
                  autoAlpha: 0,
                  force3D: "auto",
                  ease: T
              }), 0),
          ...
          if (12 == t || 13 == t || 14 == t || 15 == t) {
              ...
              var F = r.width
                ...
                , oe = y / 1e3
                , ae = oe;
              ("fullwidth" == r.sliderLayout || "fullscreen" == r.sliderLayout) && (F = K.width(),
              G = K.height()),
              ...
              f.add(punchgs.TweenLite.set(s, {
                  zIndex: 20
              }), 0),
              8 == m ? (f.add(punchgs.TweenLite.set(l, {
                  zIndex: 20
              }), 0),
              f.add(punchgs.TweenLite.set(s, {
                  zIndex: 15
              }), 0),
              f.add(punchgs.TweenLite.set(ie, {
                  left: 0,
                  top: 0,
                  scale: 1,
                  opacity: 1,
          ...
          if (16 == t) {
              ...
              f.add(punchgs.TweenLite.fromTo(l.find(".tp-half-one"), y / 800, {
                  width: F,
                  height: G / 2,
                  position: "absolute",
                  top: "0px",
              ...
              f.add(punchgs.TweenLite.fromTo(l.find(".tp-half-two"), y / 800, {
                  width: F,
                  height: G,
                  overflow: "hidden",
                  position: "absolute",
                  ...
                  onComplete: function () {
                      ...
                      l.find(".tp-half-one").length > 0 && (l.find(".tp-half-one .defaultimg").unwrap(),
                      l.find(".tp-half-one .slotholder").unwrap()),
                      l.find(".tp-half-two").remove()
                  }
              }), 0),
              j.add(punchgs.TweenLite.set(d.find(".defaultimg"), {
                  autoAlpha: 1
              }), 0),
              null != l.html() && f.add(punchgs.TweenLite.fromTo(s, (y - 200) / 1e3, {
                  scale: pe,
                  x: r.width / 4 * de,
                  y: G / 4 * he,
                  rotation: le,
          ...
          19 == t || 22 == t) {
              ...
              d.find(".slotslide").each(function (t) {
                  ...
                  j.add(punchgs.TweenLite.to(e, .1, {
                      autoAlpha: 1,
                      delay: 50 * t / 1e3
                  }), 0),
                  f.add(j)
          ...
          if (21 == t || 25 == t) {
              ...
              1 != g ? (we = -r.width,
              ue = 90,
              25 == t ? (ge = "center top 0",
              ve = -ue,
              ue = r.rotate) : (ge = "left center 0",
              ve = r.rotate)) : (we = r.width,
              ue = -90,
              25 == t ? (ge = "center bottom 0",
              ve = -ue,
              ue = r.rotate) : (ge = "right center 0",
              ve = r.rotate)),
              h.find(".slotslide").each(function () {
                  var t = jQuery(this);
          ...
          if (23 == t || 24 == t) {
              ...
              h.find(".slotslide").each(function (e) {
                  ...
                  23 == t && f.add(punchgs.TweenLite.fromTo(o, y / 2e3, {
                      autoAlpha: 1
                  }, {
                      autoAlpha: 0,
