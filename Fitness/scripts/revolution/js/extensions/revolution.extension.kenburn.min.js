    ...
    jQuery.extend(!0, t, {
        ...
        startKenBurn: function (t, e, a) {
            var r = t.data()
              ...
              , i = (r.owidth / r.oheight,
            "carousel" === e.sliderType ? e.carousel.slide_width : e.ul.width())
              , o = e.ul.height();
            t.data("kbtl") && t.data("kbtl").kill(),
            a = a || 0,
            0 == t.find(".tp-kbimg").length && (t.append('<div class="tp-kbimg-wrap" style="z-index:2;width:100%;height:100%;top:0px;left:0px;position:absolute;"><img class="tp-kbimg" src="' + s + '" style="position:absolute;" width="' + r.owidth + '" height="' + r.oheight + '"></div>'),
            ...
            var d = function (t, e, a, r, n, s, i) {
              ...
              , l = function (t, e, a, r, n) {
                  ...
                  var l = new Object;
                  return l.start = d(n.start.width, n.start.height, n.start.scale, e, a, i, o),
              ...
              , h = function (t, e, a) {
                  ...
                  a.bgposition = "center center" == a.bgposition ? "50% 50%" : a.bgposition;
                  {
                      var o = new Object
                        , d = t * r
                        , h = (d / a.owidth * a.oheight,
                      t * n);
                      h / a.owidth * a.oheight
                  }
                  if (o.start = new Object,
                  o.starto = new Object,
                  o.end = new Object,
                  o.endo = new Object,
                  o.start.width = t,
                  ...
                  var c = g.start.r - g.start.l
                    ...
                    , u = g.end.r - g.end.l
                    , f = g.end.b - g.end.t;
                  return s[0] = s[0] > 0 ? 0 : c + s[0] < t ? t - c : s[0],
            ...
            ;
            void 0 != t.data("kbtl") && (t.data("kbtl").kill(),
            t.removeData("kbtl"));
